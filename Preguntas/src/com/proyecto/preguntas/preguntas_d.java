...
public class preguntas_d {
    
    public static Pregunta[] crear_Array_preguntas_d(){
        
        // Rango de 0 a 20
        int i = 20;
                
        // Array donde guardaremos las preguntas
        Pregunta []preguntas_d = new Pregunta [i];
        
        // Fichero del que sacaremos las preguntas
        File fichero = new File("C:\\Users\\Samu\\Documents\\NetBeansProjects\\Proyecto_Pregunta\\Proyecto_Preguntas\\Preguntas_dificiles");
        ...
        try {
            ...
            while (scnr.hasNextLine()) {   
                ...
                // Lo mete en el array preguntas_d
                preguntas_d[i] = x;
